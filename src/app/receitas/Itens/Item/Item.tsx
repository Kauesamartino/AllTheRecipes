...
export default function Item(props: Prato) {
    ...
    return (
        <div className="border border-[#ffd5b5] rounded-[10px] cursor-pointer flex flex-wrap p-[20px] transition duration-200 ease-in h-max-[200px] hover:scale-105 mb-[20px]" onClick={() => router.push(`/prato/${id}`)}>
